...
| `polygone tui` | Lance l'interface TUI interactive |

## Interface TUI

Une interface terminal interactive qui centralise tout:

```bash
polygone-tui        # Lance le TUI
# ou
polygone tui        # Lance le TUI Rust
```

Navigation: `1` Accueil · `2` Identité · `3` Messages · `4` Réseau · `5` Config · `q` Quitter
